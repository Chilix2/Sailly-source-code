...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Sailly brand colors (from sailly.de)
        "brand-pink":   "#e60076",
        "brand-cream":  "#f5e9e4",
        "brand-navy":   "#000000", // Forced to pure black
        "brand-salmon": "#fe9685",
        "brand-slate":  "#000000", // Force slate to pure black
        "brand-muted":  "#000000", // Force muted to pure black
        "brand-peach":  "#fec081",

        // Sailly dashboard colors (dark theme)
        background: "#0b1628",
        surface: "#0e1e35",
        surface2: "#132540",
        border: "#1a3050",
