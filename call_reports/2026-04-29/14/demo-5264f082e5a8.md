...
| Parameter | Value |
|-----------|-------|
| **Call SID** | `demo-5264f082e5a8` |
| **Caller / channel** | `browser_demo` |
| **Started** | 2026-04-29 14:40:21 UTC |
| **Ended** | 2026-04-29 14:41:02 UTC |
| **Duration** | **40 seconds (0:40 min)** |
| **Total DB turns** | 1 |
| **Outcome / reason** | `client_disconnect` |
| **Quality score** | 5.0 / 10 |
| **Avg latency (stored)** | 1753 ms |
| **p95 latency (stored)** | 1753 ms |
| **Max latency (stored)** | 1753 ms |
| **Was escalated** | False |
| **Tenant** | `—` |
| **Est. cost (stored)** | 57.4315 ¢ |
...
| Check | Value | Notes |
|-------|-------|-------|
| Latency p50 / p95 / max (total) | 1753 / 1753 / 1753 ms | Alert threshold env `MONITOR_LATENCY_P95_MS=3000` |
| LLM span (approx) p50 / max | 1749 / 1749 ms | From `llm_latency_ms` column |
...
stt_ms / extract_ms / l2_ms / tool_ms / tts_first_byte_ms: None / 1727 / None / 19 / None
...
**User:** Hallo, Sally. Ich wollte nur kurz quatschen. Wie geht's dir denn heute?

**Bot:** Danke der Nachfrage — mir geht's prima, und hier im DOBOO duftet's heute wieder herrlich nach Kimchi und gegrilltem Bulgogi! Womit kann ich Ihnen helfen?
...
|------|----------|--------|--------|----------|--------|--------------|-----------|------|-----|-------|-------|
| 1 | 1753 | 1749 | 3 | None | — | 200 | greeting_first | neutral | None | get_date_info,get_menu,ai_greeting |  |
...
- **user** (turn 1): Hallo, Sally. Ich wollte nur kurz quatschen. Wie geht's dir denn heute?
