...
| Parameter | Value |
|-----------|-------|
| **Call SID** | `demo-1f12375d708b` |
| **Caller / channel** | `browser_demo` |
| **Started** | 2026-04-29 16:26:49 UTC |
| **Ended** | 2026-04-29 16:27:33 UTC |
| **Duration** | **44 seconds (0:44 min)** |
| **Total DB turns** | 1 |
| **Outcome / reason** | `client_disconnect` |
| **Quality score** | 5.0 / 10 |
| **Avg latency (stored)** | 1780 ms |
| **p95 latency (stored)** | 1780 ms |
| **Max latency (stored)** | 1780 ms |
| **Was escalated** | False |
| **Tenant** | `—` |
| **Est. cost (stored)** | 62.9515 ¢ |
...
| Check | Value | Notes |
|-------|-------|-------|
| Latency p50 / p95 / max (total) | 1780 / 1780 / 1780 ms | Alert threshold env `MONITOR_LATENCY_P95_MS=3000` |
| LLM span (approx) p50 / max | 1776 / 1776 ms | From `llm_latency_ms` column |
...
stt_ms / extract_ms / l2_ms / tool_ms / tts_first_byte_ms: None / 1752 / None / 21 / None
...
**User:** Sally, Achtung, Du hast dich schon wieder falsch vorgestellt. Diesmal als Sally von Dubo Koreanisch Soul Food. Der Name ist falsch und die Formulierung ist auch sehr steif. Das klingt nicht wie eine echte Mitarbeiterin eines Restaurants in Bonn.
...
|------|----------|--------|--------|----------|--------|--------------|-----------|------|-----|-------|-------|
| 1 | 1780 | 1776 | 4 | None | — | 200 | greeting_first | neutral | None | get_menu,ai_greeting |  |
...
- **user** (turn 1): Sally, Achtung, Du hast dich schon wieder falsch vorgestellt. Diesmal als Sally von Dubo Koreanisch Soul Food. Der Name ist falsch und die Formulierung ist auch sehr steif. Das klingt nicht wie eine echte Mitarbeiterin eines Restaurants in Bonn.
- **user** (turn 2): Das war jetzt
