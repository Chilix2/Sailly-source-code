...
| Parameter | Value |
|-----------|-------|
| **Call SID** | `demo-06b602404e01` |
| **Caller / channel** | `browser_demo` |
| **Started** | 2026-04-28 22:26:54 UTC |
| **Ended** | 2026-04-28 22:27:27 UTC |
| **Duration** | **33 seconds (0:33 min)** |
| **Total DB turns** | 1 |
| **Outcome / reason** | `client_disconnect` |
| **Quality score** | 5.0 / 10 |
| **Avg latency (stored)** | 1548 ms |
| **p95 latency (stored)** | 1548 ms |
| **Max latency (stored)** | 1548 ms |
| **Was escalated** | False |
| **Tenant** | `—` |
| **Est. cost (stored)** | 47.6063 ¢ |
...
| Check | Value | Notes |
|-------|-------|-------|
| Latency p50 / p95 / max (total) | 1548 / 1548 / 1548 ms | Alert threshold env `MONITOR_LATENCY_P95_MS=3000` |
| LLM span (approx) p50 / max | 1542 / 1542 ms | From `llm_latency_ms` column |
...
stt_ms / extract_ms / l2_ms / tool_ms / tts_first_byte_ms: None / 1634 / None / 75 / None
...
**User:** Selly, Achtung, Du hast schon wieder den komplett falschen Namen gesagt. Es heißt nicht Duhu Korean South Food. Das ist jetzt wirklich peinlich.

**Bot:** Sie haben völlig recht, entschuldigen Sie — ich bin Sailly von DOBOO Korean Soulfood hier in Bonn, nicht Duhu oder sonst etwas. Das tut mir leid für die Verwirrung!
...
|------|----------|--------|--------|----------|--------|--------------|-----------|------|-----|-------|-------|
| 1 | 1548 | 1542 | 5 | None | — | 200 | greeting_first | neutral | None | ai_greeting,get_menu |  |
...
- **user** (turn 1): Selly, Achtung, Du hast schon wieder den komplett falschen Namen gesagt. Es heißt nicht Duhu Korean South Food. Das ist jetzt wirklich peinlich.
