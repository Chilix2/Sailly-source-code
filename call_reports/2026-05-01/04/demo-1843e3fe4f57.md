...
| Check | Value | Notes |
|-------|-------|-------|
| Latency p50 / p95 / max (total) | 1308 / 1308 / 1308 ms | Alert threshold env `MONITOR_LATENCY_P95_MS=3000` |
| LLM span (approx) p50 / max | 1302 / 1302 ms | From `llm_latency_ms` column |
| STT p50 | 6 ms | From `stt_latency_ms` |
| Loop incidents | 0 | `loop_detected_in_stream` |
| Barge-in successes | 0 | `barge_in_succeeded` |
| Error codes (distinct) | — | `error_codes` |
| **[Phase 3] TTS latency** p50 / max | 1303 / 1303 ms (1 turns) | From `tts_latency_ms` |
...
|------|----------|--------|--------|----------|--------|--------------|-----------|------|-----|-------|-------|
| 1 | 1308 | 1302 | 6 | None | — | 200 | greeting_first | neutral | None | ai_greeting,get_date_info |  |
...
```json
{
  ...
  "caller": "browser_demo",
  "call_sid": "demo-1843e3fe4f57",
  "ended_at": "2026-05-01T06:43:17.095292+02:00",
  "started_at": "2026-05-01T06:42:40.143431+02:00",
  "started_ts": 1777610560.143436,
  "tool_calls": [],
  "from_number": "browser",
  "transcripts": [
    {
      ...
      "timestamp": "2026-05-01T06:42:46.453053+02:00"
    }
  ],
  "duration_secs": 37.0,
  "emergency_events": [],
  "emergency_detected": false,
  "recording_consent_at": "2026-05-01T06:42:40.143431+02:00",
