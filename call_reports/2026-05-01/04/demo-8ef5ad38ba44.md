...
| **p95 latency (stored)** | 1259 ms |
| **Max latency (stored)** | 1266 ms |
| **Was escalated** | False |
| **Tenant** | `—` |
| **Est. cost (stored)** | 37.6137 ¢ |
...
| Check | Value | Notes |
|-------|-------|-------|
| Latency p50 / p95 / max (total) | 1119 / 1266 / 1266 ms | Alert threshold env `MONITOR_LATENCY_P95_MS=3000` |
| LLM span (approx) p50 / max | 1233 / 1233 ms | From `llm_latency_ms` column |
| STT p50 | 33 ms | From `stt_latency_ms` |
| Loop incidents | 0 | `loop_detected_in_stream` |
| Barge-in successes | 0 | `barge_in_succeeded` |
| Error codes (distinct) | — | `error_codes` |
| **[Phase 3] TTS latency** p50 / max | 1234 / 1234 ms (2 turns) | From `tts_latency_ms` |
...
**Bot:** Sehr gerne! Möchten Sie einen Tisch reservieren, eine Bestellung aufgeben oder haben Sie eine Frage zu unserem Restaurant?
...
|------|----------|--------|--------|----------|--------|--------------|-----------|------|-----|-------|-------|
| 1 | 1119 | 1115 | 4 | None | — | 200 | greeting_first | neutral | None | ai_greeting,get_date_info |  |
| 2 | 1266 | 1233 | 33 | None | — | 200 | info_neutral | neutral | None | ai_greeting,get_date_info |  |
...
```json
{
    ...
    "adk_brain": {
      "state": {
        ...
        "recent_responses": [
          ...
          "Sehr gerne! Möchten Sie einen Tisch reservieren, eine Bestellung aufgeben oder haben Sie eine Frage zu unserem Restaurant?"
        ],
  ...
  "caller": "browser_demo",
  "call_sid": "demo-8ef5ad38ba44",
  "ended_at": "2026-05-01T06:45:45.134869+02:00",
  "started_at": "2026-05-01T06:45:18.262258+02:00",
  "started_ts": 1777610718.2622662,
  "tool_calls": [],
  "from_number": "browser",
  "transcripts": [
    {
      "role": "user",
      "text": "Guten Tag,",
      "timestamp": "2026-05-01T06:45:19.148434+02:00"
    },
    {
      "role": "user",
      "text": "Wie kann ich Ihnen helfen?",
      "timestamp": "2026-05-01T06:45:22.525256+02:00"
    }
  ],
  "duration_secs": 26.9,
  "emergency_events": [],
  "emergency_detected": false,
  "recording_consent_at": "2026-05-01T06:45:18.262258+02:00",
