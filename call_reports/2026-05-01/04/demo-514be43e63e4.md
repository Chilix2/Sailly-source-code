...
```json
{
  "state": {
    "adk_brain": {
      "state": {
        ...
        "recent_responses": [
          "Willkommen bei DOBOO Korean Soulfood in Bonn! Wie kann ich Sie heute an diesem schönen Freitagabend unterstützen?"
        ],
      ...
      "memory": {
        "recent_turns": [
          {
            "bot": "Willkommen bei DOBOO Korean Soulfood in Bonn! Wie kann ich Sie heute an diesem schönen Freitagabend unterstützen?",
            "node": "greeting",
            "customer": "<call_start>"
          }
        ],
  ...
  "caller": "browser_demo",
  "call_sid": "demo-514be43e63e4",
  "ended_at": "2026-05-01T06:01:04.648571+02:00",
  "started_at": "2026-05-01T06:00:25.272108+02:00",
  "started_ts": 1777608025.2721152,
  "tool_calls": [],
  "from_number": "browser",
  "transcripts": [],
  "duration_secs": 39.4,
  ...
  "recording_consent_at": "2026-05-01T06:00:25.272108+02:00",
