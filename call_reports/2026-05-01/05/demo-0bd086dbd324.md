...
| Parameter | Value |
|-----------|-------|
| **Call SID** | `demo-0bd086dbd324` |
| **Caller / channel** | `[validation:A3_opening_hours_wuetend]` |
| **Started** | 2026-05-01 05:36:00 UTC |
| **Ended** | 2026-05-01 05:37:15 UTC |
...
| LLM span (approx) p50 / max | 8 / 8 ms | From `llm_latency_ms` column |
| STT p50 | 3 ms | From `stt_latency_ms` |
| Loop incidents | 0 | `loop_detected_in_stream` |
| Barge-in successes | 0 | `barge_in_succeeded` |
| Error codes (distinct) | — | `error_codes` |
| **[Phase 3] TTS latency** p50 / max | 8 / 8 ms (1 turns) | From `tts_latency_ms` |
