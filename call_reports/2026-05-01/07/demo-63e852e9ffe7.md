...
| Parameter | Value |
|-----------|-------|
| **Call SID** | `demo-63e852e9ffe7` |
| **Caller / channel** | `[validation:A1_meta_feedback_eilig]` |
| **Started** | 2026-05-01 07:21:36 UTC |
| **Ended** | 2026-05-01 07:22:21 UTC |
...
```json
{
  "state": {
    "adk_brain": {
      "state": {
        ...
        "recent_responses": [
          "Herzlich willkommen bei DOBOO Korean Soulfood in Bonn! Wie kann ich Sie heute helfen?"
        ],
      ...
      "memory": {
        "recent_turns": [
          {
            "bot": "Herzlich willkommen bei DOBOO Korean Soulfood in Bonn! Wie kann ich Sie heute helfen?",
            "node": "greeting",
            "customer": "<call_start>"
          }
        ],
  ...
  "caller": "browser_demo",
  "call_sid": "demo-63e852e9ffe7",
  "ended_at": "2026-05-01T09:22:21.441904+02:00",
  "started_at": "2026-05-01T09:21:36.728626+02:00",
  "started_ts": 1777620096.7286587,
  "tool_calls": [],
  "from_number": "browser",
  "transcripts": [],
  "duration_secs": 44.7,
  ...
  "recording_consent_at": "2026-05-01T09:21:36.728626+02:00",
