...
| Parameter | Value |
|-----------|-------|
| **Call SID** | `demo-5777ac995fc5` |
| **Caller / channel** | `[validation:A1_meta_feedback_aeltere_person]` |
| **Started** | 2026-05-01 07:08:09 UTC |
| **Ended** | 2026-05-01 07:09:02 UTC |
...
**User:** Hello. Ich möchte einen Tisch reservieren.
...
|------|----------|--------|--------|----------|--------|--------------|-----------|------|-----|-------|-------|
| 1 | 11 | 7 | 3 | None | — | 200 | info_neutral | neutral | None | get_menu |  |

---

## 6. Transcripts (`google_transcripts`)

- **user** (turn 0): Hello. Ich möchte einen Tisch reservieren.
